...
import { ClipboardExtension } from "@/components/tiptap/tiptap-extension/clipboard-extension";
...
import { useLinkSelection } from "@/hooks/use-link-selection";

// --- Components ---
import { ThemeToggle } from "@/components/tiptap/tiptap-templates/title-editor/theme-toggle";
import { LinkToImageFloatingButton } from "@/components/tiptap/tiptap-ui/link-to-image-button";

// --- Lib ---
import { handleImageUpload, MAX_FILE_SIZE } from "@/lib/tiptap-utils";

// --- Styles ---
import "@/components/tiptap/tiptap-templates/title-editor/title-editor.scss";
...
export function TitleEditor({
    ...
    extensions: [
      ...
      ImageUploadNode.configure({
        ...
        upload: (file, onProgress, abortSignal) =>
          handleImageUpload(file, onProgress, abortSignal, postId),
        onError: (error) => console.error("Upload failed:", error),
      }),
      TrailingNode,
      Link.configure({ openOnClick: false }),
      ClipboardExtension.configure({
  ...
  const { isLinkSelected, linkUrl, position, hideLinkSelection } =
    useLinkSelection(editor);
  ...
  return (
    <div
      className={
        fullscreen ? "fullscreen-editor-container" : "blog-editor-container"
      }
    >
      <EditorContext.Provider value={{ editor }}>
        ...
        <div className="content-wrapper">
          {/* 제목 입력 영역 (fullscreen일 때만 표시) */}
          {fullscreen && onTitleChange && (
            <div className="border-b shrink-0">
              <div className="title-input-container">
                <Input
                  ...
                  className="text-3xl font-bold border-none shadow-none focus-visible:ring-0 px-0 bg-transparent placeholder:text-muted-foreground !bg-transparent"
                  style={{
                    fontSize: "2rem",
                    lineHeight: "2.5rem",
        ...
        {/* Floating button for converting links to images */}
        <LinkToImageFloatingButton
          editor={editor}
          position={position}
          visible={isLinkSelected}
          linkUrl={linkUrl}
          onConvert={hideLinkSelection}
        />
